...
#define APDS9960_I2C_ADDR       0x39<<1 //Last byte R/W
...
private:
    ...
    bool APDS_9960_Write(uint8_t reg,uint8_t val);
    bool APDS_9960_Read(uint8_t reg,uint8_t &val);
    int APDS_9960_Read_Block(uint8_t reg, uint8_t *val, unsigned int len);
